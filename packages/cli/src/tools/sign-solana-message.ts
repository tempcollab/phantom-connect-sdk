...
import { WalletIdSchema, DerivationIndexSchema, SolanaCaip2ChainIdSchema } from "./schemas.js";

export const signSolanaMessageSchema = z.object({
...
export type SignSolanaMessageParams = z.infer<typeof signSolanaMessageSchema>;

export const signSolanaMessageTool = createTool({
  ...
  inputSchema: signSolanaMessageSchema,
  annotations: {
    readOnlyHint: false,
