...
import { WalletIdSchema, DerivationIndexSchema, Caip2ChainIdSchema, PercentageSchema } from "./schemas.js";
...
export type BuyTokenParams = z.infer<typeof buyTokenSchema>;
