...
import { WalletIdSchema, PercentageSchema, Caip19Schema } from "./schemas.js";
...
export type PortfolioRebalanceParams = z.infer<typeof portfolioRebalanceSchema>;

export const portfolioRebalanceTool = createTool({
  ...
  inputSchema: portfolioRebalanceSchema,
  annotations: {
