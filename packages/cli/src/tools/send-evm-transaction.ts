...
export const sendEvmTransactionSchema = z.object({
...
export type SendEvmTransactionParams = z.infer<typeof sendEvmTransactionSchema>;

export const sendEvmTransactionTool = createTool({
  ...
  inputSchema: sendEvmTransactionSchema,
  annotations: {
    readOnlyHint: false,
