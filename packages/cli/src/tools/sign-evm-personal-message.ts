...
export const signEvmPersonalMessageSchema = z.object({
...
export type SignEvmPersonalMessageParams = z.infer<typeof signEvmPersonalMessageSchema>;

export const signEvmPersonalMessageTool = createTool({
  ...
  inputSchema: signEvmPersonalMessageSchema,
  annotations: {
    readOnlyHint: false,
